...
| Area | What you get |
|------|--------------|
| 🖥️ Launcher UI | Dark brown modern UI: **Injection**, **Console**, **Support** tabs |
| ⚔️ Combat | Triggerbot, legit Aim Assist, Hit Select (cooldown-gated) |
| 👁️ Visuals | Target ESP (box + distance + HP) |
